# Developer UX Protocol — Single Source of Truth

** Every agent and skill MUST follow these 6 rules for ALL user interactions.**
...
Follow the engagement mode given as input by the user on first plugin execution. Autonomy scales inversely with engagement level:
